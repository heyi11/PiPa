...
public class TouchArduino : MonoBehaviour
{
    //定义基本信息
    ...
    public void OnTouchBegin(Touch touch, int id)
    {
        ...
        if (touchInfo == null)
        {
            ...
            if(triggerType==TriggerType.LEFTHAND){
                sv.TriggerLimZSet(transform.position.y);
    ...
    public void OnTouchDrag(Touch touch, int id)
    {
        ...
        if (touchInfo != null)
        {
            ...
            if(triggerType==TriggerType.LEFTHAND){
                ...
                //sv.TriggerLimZSet(transform.localPosition.z);
                sv.OnStringDragging(dis.y,(transform.localPosition.z-17.5f)*(-0.109f-0.419f-(-1.03f+0.134f))/(-14.04f-17.5f)+(-1.03f+0.134f));
